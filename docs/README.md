...
|----------|-------------|
| [Architecture](./ARCHITECTURE.md) | Project structure, design philosophy, module organization |
| [Coding Standards](./CODING_STANDARDS.md) | TypeScript conventions, style guide, best practices |
| [API Reference](./API_REFERENCE.md) | Complete function and class documentation |
| [Algorithms](./ALGORITHMS.md) | Detailed algorithm explanations and theory |
| [Testing](./TESTING.md) | Unit testing and visual testing guide |
...
| Document | Description |
|----------|-------------|
| [p5.js Overview](./p5js/README.md) | How p5.js is used in p5.gen |
| [p5.Vector](./p5js/VECTOR.md) | Vector class (essential for this library) |
| [Drawing](./p5js/DRAWING.md) | Shape, color, and transform functions |
| [Math](./p5js/MATH.md) | Math utilities, random, noise |
| [Types](./p5js/TYPES.md) | Key types and constants |
